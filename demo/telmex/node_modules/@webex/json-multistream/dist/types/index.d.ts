...
declare class AV1Codec {
    ...
    constructor(levelIdx: number, tier: number, maxWidth: number, maxHeight: number, maxPicSize: number, maxDecodeRate: number);
}
declare function isValidAV1Codec(msg: unknown): msg is AV1Codec;
declare function areAV1CodecsEqual(left: AV1Codec | undefined, right: AV1Codec | undefined): boolean;
...
declare class CodecInfo {
    ...
    av1?: AV1Codec;
    private constructor();
    static fromH264(payloadType: number, h264: H264Codec): CodecInfo;
    static fromAv1(payloadType: number, av1: AV1Codec): CodecInfo;
}
...
export { AV1Codec, ActiveSpeakerInfo, ActiveSpeakerNotificationMsg, CodecInfo, H264Codec, JmpMsg, JmpMsgType, JmpSession, JmpSessionEvents, MediaContent, MediaFamily, MediaRequestAckMsg, MediaRequestMsg, MediaRequestStatusAckMsg, MediaRequestStatusMsg, MediaType, MidRidStreamId, NamedMediaGroup, Policy, PolicySpecificInfo, ReceiverSelectedInfo, SourceAdvertisementAckMsg, SourceAdvertisementMsg, SsrcStreamId, StreamId, StreamInfo, StreamRequest, StreamState, VideoContentHint, areAV1CodecsEqual, areActiveSpeakerInfosEqual, areArraysEqual, areCodecInfosEqual, areH264CodecsEqual, areNamedMediaGroupsEqual, arePolicySpecificInfosEqual, areReceiverSelectedInfosEqual, areSourceAdvertisementMsgsEqual, areStreamIdsEqual, areStreamInfosEqual, areStreamRequestsEqual, generateCsi, generateSceneId, getMediaContent, getMediaFamily, getMediaType, isTruthyOrZero, isValidAV1Codec, isValidActiveSpeakerInfo, isValidActiveSpeakerNotificationMsg, isValidCodecRequestInfo, isValidH264Codec, isValidJmpMsg, isValidJmpMsgPayload, isValidMediaRequestAckMsg, isValidMediaRequestMsg, isValidMediaRequestStatusAckMsg, isValidMediaRequestStatusMsg, isValidMidRidStreamId, isValidReceiverSelectedInfo, isValidSourceAdvertisementAckMsg, isValidSourceAdvertisementMsg, isValidSsrcStreamId, isValidStreamId, isValidStreamInfo, isValidStreamRequest };
