...
import { compileShader as h, linkProgram as a } from "../util.js";
import { WebGLRenderer as g } from "./webgl-renderer.js";
class c extends g {
  constructor(e, i) {
...
`, this.config.render.kernelSize % 2 === 0 && s.errorAndThrow("Kernel_size must be odd");
    {
      const r = h(
        this.gl,
      ...
      this.program_1 = a(this.gl, r, t), this.gl.useProgram(this.program_1);
      const o = this.gl.createFramebuffer();
      o || s.errorAndThrow("Error creating framebuffer"), this.framebuffer = o;
      const n = this.gl.createTexture();
      n || s.errorAndThrow("Error creating output texture"), this.transfer_texture = n, this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, this.framebuffer), this.gl.bindTexture(this.gl.TEXTURE_2D, this.transfer_texture), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MIN_FILTER, this.gl.LINEAR), this.gl.texParameteri(
        this.gl.TEXTURE_2D,
      ...
      l || s.errorAndThrow('Error finding "u_kernel" uniform'), this.gl.uniform1fv(l, this.getBlurKernel());
    }
    {
      const r = h(
        this.gl,
      ...
      this.program_2 = a(this.gl, r, t), this.gl.useProgram(this.program_2);
      const o = this.gl.getUniformLocation(this.program_2, "u_blur");
      o || s.errorAndThrow('Error finding "u_blur" uniform'), this.u_blur = o, this.gl.activeTexture(this.gl.TEXTURE2), this.gl.bindTexture(this.gl.TEXTURE_2D, this.transfer_texture), this.gl.uniform1i(this.u_blur, 2), this.setSharedUniforms(this.program_2);
      const n = this.gl.getUniformLocation(this.program_2, "u_kernel");
      n || s.errorAndThrow('Error finding "u_kernel" uniform'), this.gl.uniform1fv(n, this.getBlurKernel());
    }
  }
  async render(e, i) {
