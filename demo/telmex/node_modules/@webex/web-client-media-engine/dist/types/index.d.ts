...
type EncodedTransformId = string;
declare enum EncodedTransformType {
...
declare class EgressSdpMunger {
    ...
    setCustomCodecParameters(codecMimeType: MediaCodecMimeType, parameters: CodecParameters): void;
    markCustomCodecParametersForDeletion(codecMimeType: MediaCodecMimeType, parameters: string[]): void;
}
...
declare class SendOnlyTransceiver extends Transceiver {
    ...
    resetSdpMunger(): void;
    setCustomCodecParameters(codecMimeType: MediaCodecMimeType, codecParams: CodecParameters): void;
    markCustomCodecParametersForDeletion(codecMimeType: MediaCodecMimeType, parameters: string[]): void;
...
declare class SendSlot {
    ...
    setCodecParameters(parameters: CodecParameters): Promise<void>;
    deleteCodecParameters(parameters: string[]): Promise<void>;
    setCustomCodecParameters(codecMimeType: MediaCodecMimeType, parameters: CodecParameters): Promise<void>;
    markCustomCodecParametersForDeletion(codecMimeType: MediaCodecMimeType, parameters: string[]): Promise<void>;
    setSourceStateOverride(state: StreamState): void;
...
declare class MultistreamConnection extends EventEmitter<MultistreamConnectionEvents> {
    ...
    setupEncodedTransform(receiverOrSender: RTCRtpReceiver | RTCRtpSender, id: EncodedTransformId, type: EncodedTransformType): void;
}
