...
exports.userAgentToString = exports.setMetricTimings = exports.prepareDiagnosticMetricItem = exports.isWebrtcApiNotAvailableError = exports.isUnauthorizedError = exports.isSdpOfferCreationError = exports.isNetworkError = exports.isMeetingInfoServiceError = exports.isLocusServiceErrorCode = exports.isBrowserMediaErrorName = exports.isBrowserMediaError = exports.getBuildType = exports.getBrowserMediaErrorCode = exports.generateClientErrorCodeForIceFailure = exports.extractVersionMetadata = exports.clearEmptyKeysRecursively = exports.anonymizeIPAddress = void 0;
 ...
 * @returns
 */
var _clearEmptyKeysRecursively = exports.clearEmptyKeysRecursively = function clearEmptyKeysRecursively(obj) {
  ...
  (0, _keys.default)(obj).forEach(function (key) {
    ...
    if ((0, _typeof2.default)(obj[key]) === 'object') {
      _clearEmptyKeysRecursively(obj[key]);
    }
  });
};
...
var isWebrtcApiNotAvailableError = exports.isWebrtcApiNotAvailableError = function isWebrtcApiNotAvailableError(rawError) {
  if (rawError.name === _config.ERROR_DESCRIPTIONS.WEBRTC_API_NOT_AVAILABLE) {
    return true;
  }
  return false;
};
 ...
 */
var isBrowserMediaError = exports.isBrowserMediaError = function isBrowserMediaError(rawError) {
 ...
 */
var getBrowserMediaErrorCode = exports.getBrowserMediaErrorCode = function getBrowserMediaErrorCode(rawError) {
  return _config.BROWSER_MEDIA_ERROR_NAME_TO_CLIENT_ERROR_CODES_MAP[rawError.name];
};
  ...
  if (webex.devicemanager) {
    ...
    if (pairedDevice) {
      ...
      var devicePayload = {
        ...
        productName: (_pairedDevice$devices = pairedDevice.devices[0]) === null || _pairedDevice$devices === void 0 ? void 0 : _pairedDevice$devices.productName
      };
