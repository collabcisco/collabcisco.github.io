...
import { PressureState } from '@webex/web-capabilities';
...
export declare const pressureStateToPercentage: (state: PressureState) => number;
export declare const roundToNearestPreset: (value: number, presets: number[]) => number;
