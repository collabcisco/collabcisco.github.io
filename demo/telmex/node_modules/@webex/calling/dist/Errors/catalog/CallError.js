...
function _isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(_Reflect$construct(Boolean, [], function () {})); } catch (t) {} return (_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); } /* eslint-disable valid-jsdoc */
/**
 *
 */
var CallError = exports.CallError = /*#__PURE__*/function (_ExtendedError) {
  ...
  function CallError(msg, context, type, correlationId, errorLayer) {
    ...
    _this = _callSuper(this, CallError, [msg, context, type]);
    (0, _defineProperty2.default)(_this, "correlationId", void 0);
    (0, _defineProperty2.default)(_this, "errorLayer", void 0);
  ...
  return (0, _createClass2.default)(CallError, [{
    key: "setCallError",
