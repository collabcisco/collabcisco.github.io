...
export interface IMetricManager {
    ...
    submitRegistrationMetric: (name: METRIC_EVENT, metricAction: REG_ACTION, type: METRIC_TYPE, caller: string, serverType: SERVER_TYPE, trackingId: string, keepaliveCount?: number, error?: LineError | CallingClientError) => void;
    ...
    submitConnectionMetrics: (name: METRIC_EVENT, metricAction: CONNECTION_ACTION, type: METRIC_TYPE, downTimestamp: string, upTimestamp: string) => void;
