export declare const VERSION = "unknown";
export declare const USER_AGENT_VERSION = "beta";
export declare const REPO_NAME = "webex-calling";
...
export declare const MAX_CALL_KEEPALIVE_RETRY_COUNT = 4;
...
export declare const NETWORK_FLAP_TIMEOUT = 5000;
...
export declare const VALID_PHONE_REGEX: RegExp;
...
export declare const UTILS_FILE = "src/common/Utils.ts";
...
export declare const RECONNECT_ON_FAILURE_UTIL = "reconnectOnFailure";
...
export declare const MOBIUS_EU_PROD = "mobius-eu-central-1.prod.infra.webex.com";
...
export declare const FAILOVER_CACHE_PREFIX = "wxc-failover-state";
export declare const ACTIVE_MOBIUS_STORAGE_KEY = "wxc-active-mobius";
...
export declare const METHODS: {
    ...
    MERCURY_OFFLINE: string;
    MERCURY_ONLINE: string;
