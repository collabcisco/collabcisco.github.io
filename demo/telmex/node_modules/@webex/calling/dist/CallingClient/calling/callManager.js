...
var CallManager = exports.CallManager = /*#__PURE__*/function (_Eventing) {
  ...
  function CallManager(webex, indicator) {
     ...
     * @param destination -.
     */
    (0, _defineProperty2.default)(_this, "createCall", function (direction, deviceId, lineId, destination) {
     ...
     * @param correlationId -.
     */
    (0, _defineProperty2.default)(_this, "getCall", function (correlationId) {
      return _this.callCollection[correlationId];
    });
    /**
     *
     */
    (0, _defineProperty2.default)(_this, "getActiveCalls", function () {
  ...
  return (0, _createClass2.default)(CallManager, [{
