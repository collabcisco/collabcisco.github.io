 ...
 * @param context - File and method which called.
 */
var logError = function logError(errorMsg, context) {
  if (currentLogLevel >= _types.LOGGING_LEVEL.error) {
    writeToLogger("".concat(format(context, '[ERROR]'), " - !").concat(_types.LOG_PREFIX.ERROR, "!").concat(_types.LOG_PREFIX.MESSAGE, ":").concat(errorMsg), _types.LOGGER.ERROR);
  }
};
