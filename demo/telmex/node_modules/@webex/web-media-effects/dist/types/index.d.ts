...
interface EffectEventCallback {
    ...
    [EffectEvent.ModelChanged]: (model: string) => void;
}
...
declare class NoiseReductionEffect extends BaseMicrophoneEffect {
    private static readonly UNKNOWN_MODEL_LABEL;
    ...
    private previousAgcState;
    private modelChangeFuture?;
    ...
    setModel(model: NoiseReductionModel): Promise<void>;
